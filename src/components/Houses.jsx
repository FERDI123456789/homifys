      ...
      <div className="text-white mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-20">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="mb-8 max-w-3xl text-center">
            ...
            {/* Select */}
            <div className="w-full rounded-3xl btnHome1 relative mx-auto flex-col md:flex-row mt-8 flex w-fit cursor-pointer bg-gray-100 md:mt-12">
              <a
                href="/homes"
                className={`relative px-5 py-2 text-black mx-auto`}
              >
                Homes
              </a>
            </div>
              ...
              <div className="flex h-full w-full flex-col items-start justify-around px-0 py-4">
				...
				<div className="flex items-center">
				  <p className="mr-2 text-sm font-bold bg-yellow-500 p-2 rounded-full hidden sm:flex">Top Rated Seller</p>
                                ...
                                {/* Button */} <a href="homes/" className="mt-10 rounded-md bg-black px-6 py-3 font-semibold text-white"> See All </a>
        </div>
